...
const SIZE = 28;
const className = "tool-card-icon";
...
export function ToolCategoryIcon({ category }: ToolCategoryIconProps) {
  return (
    <span className="tool-card-icon-wrap" data-category={category}>
      {icons[category]}
    </span>
  );
}
